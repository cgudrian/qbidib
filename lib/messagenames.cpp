...
#define MSG(msg) MessageNames[msg] = #msg;

namespace Bd {

namespace {
const char *MessageNames[256]{};

struct MessageNamesInitializer
{
    MessageNamesInitializer()
    {
...
const char *messageName(quint8 id)
{
    static MessageNamesInitializer init;
    return MessageNames[id];
}
